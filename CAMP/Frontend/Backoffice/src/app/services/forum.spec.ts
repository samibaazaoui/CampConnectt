...
describe('ForumService', () => {
  ...
  it('should fetch all forum posts', () => {
    ...
    const req = httpMock.expectOne('http://localhost:8080/api/forum/posts?page=0&size=10');
  ...
  it('should create a new post', () => {
    ...
    const req = httpMock.expectOne('http://localhost:8080/api/forum/posts');
  ...
  it('should get comments for a post', () => {
    ...
    const req = httpMock.expectOne('http://localhost:8080/api/forum/posts/9/comments');
    expect(req.request.method).toBe('GET');
    req.flush([]);
  });
});
