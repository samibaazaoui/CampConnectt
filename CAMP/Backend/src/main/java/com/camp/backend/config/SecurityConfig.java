    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/event-participations/qr/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/event-participations/qr-image/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/event-participations/ticket/**").permitAll()
